              ...
              <tr>
                <td width="320">
                    ...
                    <div id="main_left">
                     ...
                     <iframe id="left" src="<%=hotelPath %>getHotelJoinInfoLeft.do" width="100%" height="100%" frameborder="0"></iframe> 
                    </div>
                    <!--left end-->
                </td>
                <td>
                    ...
                    <div class="typechange tc1 tc_select">意向用户列表
                      <input type="hidden" class="leftSrc" value="<%=hotelPath %>getHotelJoinInfoLeft.do" /> 
                        <input type="hidden" class="rightSrc" value="<%=hotelPath %>getHotelJoinInfoRight.do" /> 
                    </div>
                    <div class="typechange tc2">无效用户列表
                    	<input type="hidden" class="leftSrc" value="<%=hotelPath %>getHotelJoinInfoLeft.do" /> 
                        <input type="hidden" class="rightSrc" value="<%=hotelPath %>getHotelJoinInfoRight.do" /> 
                    </div>
                    <div class="button-right" style="margin-top:7px;"><input type="button" id="addBtn" value="添加" class="button-xinzeng button-right" /></div>
                    <div id="main_right" >
                     <%--<%@include file="_intentCustomer_right.jsp"  %> 
                          --%><iframe id="right" src="<%=hotelPath %>getHotelJoinInfoRight.do" width="100%" height="100%" frameborder="0"></iframe>
                    </div>
                    <!--right end-->
                </td>
              </tr>
...
<script  type="text/javascript" >
	$(function(){
		$("#searchBtn").click(function(){
			var url = "<%=hotelPath %>getHotelJoinInfoRight.do";
		...
		$("#addBtn").click(function(){
			//window.open('<c:url value="/hoteljoin/input.do"></c:url>',"_self")
			window.location='<c:url value="/hoteljoin/input.do"></c:url>';
		});
	});
