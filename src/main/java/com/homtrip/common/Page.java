...
public class Page<T> {
	...
	/**
	 * 根据pageNo和pageSize计算最后一页的第一行记录编号.
	 */
	public long getLastFirst() {
		return ((getTotalPages() - 1) * pageSize) + 1;
	}
	...
	public int getNextFirst() {
		return ((getNextPage()-1)*pageSize)+1;
	}
	/**
	 * 获取上一页的首行记录编号
	 * @return
